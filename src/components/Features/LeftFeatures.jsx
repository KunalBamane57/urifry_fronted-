  ...
  return (
    <div className="w-[50%]">
      <div className="absolute lg:w-[720px] w-[425px] lg:right-[560px] lg:h-[720px]">
        <img
          className="absolute lg:top-0 top-[100px] animate-spin-slow"
          src={ColorFeatLeft}
          alt=""
        />
        <img
          className="absolute lg:top-[150px] top-[100px] animate-bounce"
          src={Star48}
          alt=""
        />
        <img
          className="relative lg:scale-95 lg:top-0 top-[100px] transition-transform transform hover:scale-105"
          src={FeaturesMobile}
          alt=""
        />
      </div>
