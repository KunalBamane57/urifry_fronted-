...
const Footer = () => {
  return (
    <div className="mt-40 dark:text-primary-white">
      {/* Links */}
      <div className="flex flex-wrap flex-1 lg:flex-nowrap lg:justify-between justify-evenly lg:mx-0 mx-12 lg:gap-0 gap-5">
        <div className="flex gap-5 mt-[6px] flex-col lg:ml-0 -ml-10 animate-fadeIn">
          <img
          ...
          <p className="a flex items-center ">
            <img className="w-[20px] h-[18px]" src={Mail} alt="Mail Icon" />
            <span className="a ml-3 font-[ClashDisplay-Medium]">
              Help@Frybix.com
            </span>
          </p>
          <p className="a flex">
            <img className="w-[20px] h-[18px]" src={Phone} alt="Phone Icon" />
        ...
        <div className="flex flex-col gap-4 lg:mt-0 mt-10 animate-fadeIn">
        ...
        <div className="flex flex-col gap-4 lg:ml-0 ml-10 lg:-mr-0 -mr-10 lg:mt-0 mt-10 animate-fadeIn">
        ...
        <div className="flex flex-col lg:gap-4 gap-2 lg:mt-0 mt-10 lg:mx-0 mx-6 animate-fadeIn">
          <h1 className="text-[32px] font-[ClashDisplay-Medium]">Newsletter</h1>
          <p className="hover:text-primary-red cursor-pointer font-[ClashDisplay-Medium]">
            Stay Up To Date
          </p>
      ...
      <div>
        <hr className="mt-28" />
        <p className="a capitalize my-10 text-center font-[ClashDisplay-Medium] mb-16 animate-fadeIn">
